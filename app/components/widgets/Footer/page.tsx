                ...
                <div className="flex flex-col gap-y-10 ">
                    ...
                    <div className="flex flex-wrap justify-center sm: space-x-16">
                        ...
                        <div className="flex max-[681px]:pr-28 space-x-5 text-slate-800">
                            <div className="px-5 border-r-2 border-slate-300 border-spacing-x-4"><Image src={github} alt="github" width={45} height={45} /></div>
                            <div><Image src={twitter} alt="github" width={27} height={27} /></div>
