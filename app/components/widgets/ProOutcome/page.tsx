    ...
    <section className="mt-16 md:mt-28">
      <Wrapper>
        <div className="flex flex-col-reverse gap-x-8 items-center">
          ...
          {/* Right content */}
          <div className="flex-1 ">
            <h2 className="font-bold text-4xl my-3">The Outcome for Participants of the Program</h2>
            <p className="text-lg text-slate-600">The graduates of this program will own products (Full-Stack App Templates, AR and VR Experiences, and APIs) that are marketed globally by the Panaverse DAO and, if they like, will also be able to start off by offering services at a rate of $50 per hour ($96,000 per year). This would give Pakistani professionals and students a fantastic opportunity to better their financial situation while also giving the economy a much-needed boost by expanding software exports.</p>
